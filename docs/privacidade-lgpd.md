...
webPosto segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Quality Automação (webPosto)** | BR | ERP provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [webposto@mcp.ai](mailto:webposto@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
